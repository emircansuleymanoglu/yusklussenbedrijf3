...
export const SERVICES = [
  {
    ...
    seoTitle: 'Stucwerk & Pleisterwerk | YUS Klussenbedrijf',
    seoDescription: 'Professioneel stucwerk en pleisterwerk door ervaren stukadoors. Gladde muren, egale plafonds en sierpleister in heel Nederland. Vraag vrijblijvend een offerte aan.',
    icon: Layers,
  ...
  },
  {
    ...
    seoTitle: 'Schilderwerk Binnen & Buiten | YUS Klussenbedrijf',
    seoDescription: 'Vakkundig schilderwerk voor binnen en buiten. Van muren en plafonds tot kozijnen en gevels. Scherpe prijzen en nette afwerking door heel Nederland.',
    icon: PaintBucket,
    color: 'text-sky-600',
    bg: 'bg-sky-50',
  ...
  },
  {
    ...
    seoTitle: 'Timmerwerk op Maat | YUS Klussenbedrijf',
    seoDescription: 'Professioneel timmerwerk op maat: deuren, kozijnen, kasten en vloeren. YUS Klussenbedrijf levert vakmanschap in heel Nederland. Vraag vrijblijvend een offerte aan.',
    icon: Hammer,
  ...
  },
  {
    ...
    seoTitle: 'Vloerverwarming Installatie | YUS Klussenbedrijf',
    seoDescription: 'Deskundige installatie van vloerverwarming – elektrisch of water. Geschikt voor parket, laminaat en tegels. YUS Klussenbedrijf in heel Nederland.',
    icon: Thermometer,
    color: 'text-red-600',
    bg: 'bg-red-50',
  ...
  },
  {
    ...
    seoTitle: 'Elektrotechniek & Elektra Werkzaamheden | YUS Klussenbedrijf',
    seoDescription: 'Betrouwbare elektrotechnische werkzaamheden: groepenkast, bedrading, stopcontacten en verlichting. YUS Klussenbedrijf – veilig en vakkundig in heel Nederland.',
    icon: Zap,
  ...
  },
  {
    ...
    seoTitle: 'Badkamer Renovatie | YUS Klussenbedrijf',
    seoDescription: 'Complete badkamerrenovatie van A tot Z: tegels, sanitair, inloopdouche en meer. YUS Klussenbedrijf levert uw droomba dkamer in heel Nederland. Gratis offerte.',
    icon: Droplets,
    color: 'text-cyan-600',
    bg: 'bg-cyan-50',
  ...
  },
  {
    ...
    seoTitle: 'Keuken Renovatie op Maat | YUS Klussenbedrijf',
    seoDescription: 'Moderne keukenrenovatie op maat: aanrechtblad, tegels, kasten en complete verbouwing. YUS Klussenbedrijf levert kwaliteit in heel Nederland. Vraag een offerte aan.',
  ...
  },
  {
    ...
    seoTitle: 'Algemene Verbouwing & Renovatie | YUS Klussenbedrijf',
    seoDescription: 'Van kleine aanpassingen tot complete verbouwingen. YUS Klussenbedrijf begeleidt uw renovatieproject van A tot Z. Betrouwbaar, vakkundig en op tijd in Nederland.',
    icon: Wrench,
